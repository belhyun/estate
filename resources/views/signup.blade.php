            ...
            <div class="container">
                <div class="content-wrap">
                    <form class="sign-form">
                        ...
                        <div class="input-field">
                            <input id="repName" type="number" class="validate">
                        ...
                        <div class="col-block">
                            <div class="row form-row">
                                <div class="input-field col s8">
                                    <input id="userAddress" type="text" class="validate modal-trigger" data-target="modalFind" disabled>
                        ...
                        <div class="col-block mb-2">
                            <div class="row form-row">
                                ...
                                <div class="input-field col s8">
                                    <input id="bankNum" type="number" class="validate">
                        ...
                        <div class="file-field input-field">
                            ...
                            <div class="file-path-wrapper file-camera">
                                <input class="file-path validate" type="text" placeholder="사업자등록증" accept="image/*;capture=camera">
                            </div>
                        </div>
