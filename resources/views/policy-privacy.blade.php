    ...
    <section class="section">
        <div class="container">
            <div class="content-wrap">
                <div class="block">
                    <h4 class="title center-align mt-0 mb-3">개인정보 처리방침</h4>

                    <ul class="policy-tab">
                        <li><a class="tab waves-effect" href="/policy-terms">서비스 이용약관</a></li>
                        <li><a class="tab waves-effect active" href="/policy-privacy">개인정보 처리방침</a></li>
                        <li><a class="tab waves-effect" href="/policy-marketing">마케팅 정보 수신동의</a></li>
                    </ul>
